...
# Hyrax
(echo -n "$(date --rfc-3339=seconds) - creating hyrax backup - " && tar -cf "{{ hyrax_backups_directory }}/current/hyrax/hyrax.tar" -C /var/www/ hyrax) >> /var/log/hyrax/backup.log 2>&1
